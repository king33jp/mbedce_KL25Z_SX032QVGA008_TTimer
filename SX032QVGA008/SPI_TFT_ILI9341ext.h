...
#ifndef MBED_SPI_TFT_ILI9341EXT_H
#define MBED_SPI_TFT_ILI9341EXT_H
 ...
 * @endcode
 */
class SPI_TFT_ILI9341ext : public GraphicsDisplay
{
public:
     ...
     */
    SPI_TFT_ILI9341ext(PinName mosi, PinName miso, PinName sclk, PinName cs, PinName reset, PinName dc, const char* name ="TFT");
